...
public class AccessModifierEx {
	...
	public static void main(String[] args) {
		A a = new A();
		B b = new B();//import해서 다른 패키지에 있는거 가져오기 scanner하는 것 처럼
		
		/* num3은 접근제어자가 public => 이것은 num3에 커서 가져다대면 녹색 동그라미임
		...
		*/
		 ...
		 * 다른 패키지에 있는 B 클래스의 객체이 있는 num2는 접근이 안됨
		 * */
		a.num2 = 10;
		//b.num2 = 20;
...
class A{
	...
	public void print() {
		...
		//이미 알고있는 내정보를 활용하는 경우 매개변수로 전달받지 않아도됨
