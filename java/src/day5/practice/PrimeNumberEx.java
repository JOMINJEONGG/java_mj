...
public class PrimeNumberEx {
	...
	public static void main(String[] args) {
		 ...
		 * 소수 : 약수가 1과 자기 자신밖에 없는 수 => 약수가 2개인 수, 1을 제외하고 처음구한 약수가 자신인 수 
		 * 소수ex : 2, 3, 5, 7, 11, 13 등
		 * */
		/* 반복성 : i는 1부터 num까지 1씩증가
		 * 규칙성 : i가 num의 약수이면 약수dml 개수 count를 1증가
